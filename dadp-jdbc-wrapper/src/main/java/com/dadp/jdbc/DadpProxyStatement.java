...
public class DadpProxyStatement implements Statement {
    ...
    public long executeLargeUpdate(String sql) throws SQLException {
        return executeWithTelemetry(sql, () -> actualStatement.executeLargeUpdate(sql), false);
    }
    
    @Override
    public long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return executeWithTelemetry(sql, () -> actualStatement.executeLargeUpdate(sql, autoGeneratedKeys), false);
    }
    
    @Override
    public long executeLargeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return executeWithTelemetry(sql, () -> actualStatement.executeLargeUpdate(sql, columnIndexes), false);
    }
    
    @Override
    public long executeLargeUpdate(String sql, String[] columnNames) throws SQLException {
        return executeWithTelemetry(sql, () -> actualStatement.executeLargeUpdate(sql, columnNames), false);
    }
